...
const items = [
  ['Dashboard','/dashboard'],['Kunden','/kunden'],['Angebote','/angebote'],['Angebotsvorbereitung','/angebotsvorbereitung'],['Kalkulationsarchiv','/kalkulationsarchiv'],['Projekte','/projekte'],['Operations Center','/operations'],['Mitarbeiter Mobile','/mitarbeiter-mobile'],['Baustellenmeldungen','/baustellenmeldungen'],['Mitarbeiter','/mitarbeiter'],['Mitarbeiterverfügbarkeit','/mitarbeiterverfuegbarkeit'],['Benutzer','/benutzer'],['Cloud Setup','/admin/cloud-setup'],['Einkauf','/einkauf'],['Lieferanten','/lieferanten'],['Lieferungen','/lieferungen'],

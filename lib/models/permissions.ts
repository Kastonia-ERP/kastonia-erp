import type {Permission,Project,SiteReport,User} from '../types';

export const ADMIN_PERMISSIONS: Permission[] = ['projects:read','projects:write','projects:delete','offers:read','offers:write','purchasing:manage','deliveries:manage','users:manage','siteReports:create','siteReports:read','siteReports:write','siteReports:close','images:manage','analytics:read','finance:read','masterData:write'];
export const EMPLOYEE_PERMISSIONS: Permission[] = ['projects:read','siteReports:create','siteReports:read'];

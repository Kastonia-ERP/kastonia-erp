...
import {LEGACY_STORAGE_KEY_V07,PERSISTENCE_SCHEMA_VERSION,STORAGE_KEY_V09,createProjectNumber,updateProjectBaseData} from './models/project-helpers';
...
type ProjectBaseUpdate = Pick<Project, 'status' | 'phase' | 'priority' | 'responsible' | 'montage'>;
type Api={state:State;setState:React.Dispatch<React.SetStateAction<State>>;add:<K extends CollectionKey>(key:K,item:State[K][number] | Record<string, unknown>)=>void;update:<K extends CollectionKey>(key:K,id:string,item:State[K][number] | Record<string, unknown>)=>void;updateProjectBase:(id:string, item:ProjectBaseUpdate)=>void;remove:(key:CollectionKey,id:string)=>void;reset:()=>void;exportData:()=>void};

export const initial:State={
 schemaVersion:PERSISTENCE_SCHEMA_VERSION,
 customers:[{id:'K-1001',name:'OBI Beispielkunde Nord',email:'',phone:'',city:'',status:'Aktiv'},{id:'K-1002',name:'Beispielkunde Süd',email:'',phone:'',city:'',status:'Aktiv'},{id:'K-1003',name:'Musterkunde',email:'',phone:'',city:'',status:'Aktiv'}],
 offers:[{id:'AG12553',customer:'OBI Beispielkunde Nord',title:'Pultdach + Markise',net:20882.35,status:'Auftrag',date:'2026-05-09'}],
 ...
 tasks:[{id:'T1',title:'Musterangebot überarbeiten',due:'2026-07-20',priority:'Hoch',done:false},{id:'T2',title:'OBI-Leads nachfassen',due:'2026-07-21',priority:'Hoch',done:false},{id:'T3',title:'Musterprojekt Senkrechtmarkise aufmessen',due:'2026-07-22',priority:'Mittel',done:false}],
 appointments:[{id:'KA1',title:'Aufmaß Musterkunde',date:'2026-07-20',type:'Aufmaß'},{id:'KA2',title:'Mustertermin',date:'2026-07-23',type:'Kundentermin'},{id:'KA3',title:'Montage Musterkunde',date:'2026-07-27',type:'Montage'}],
 invoices:[{id:'R1',direction:'Ausgang',number:'RE12763',partner:'Musterkunde',project:'Terrassendach',date:'2026-05-02',due:'2026-07-30',net:6550,vatRate:19,status:'Offen'},{id:'R2',direction:'Eingang',number:'ER-2026-44',partner:'Lewens',project:'Musterprojekt',date:'2026-07-12',due:'2026-08-05',net:4200,vatRate:19,status:'Offen'},{id:'R3',direction:'Eingang',number:'2026/4/070228',partner:'Aluprof',project:'Musterprojekt',date:'2026-07-20',due:'2026-08-03',net:1793.30,vatRate:0,status:'Offen'}],
